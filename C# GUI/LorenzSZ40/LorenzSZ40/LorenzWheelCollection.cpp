...
string LorenzWheelCollection::getChiWheelsLineValue()
{
	string chivalue = "00000";

	for (int i = 0; i < 5; i++)
	{
		chivalue[i] = (char)chilinevalue[i];
	}

	return chivalue;
}

string LorenzWheelCollection::getPsiWheelsLineValue()
{
	string psivalue = "00000";

	for (int i = 0; i < 5; i++)
	{
		psivalue[i] = (char)psilinevalue[i];
	}
